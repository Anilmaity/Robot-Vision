...
def setRobot(client_id,link, joint_angle,  handle_value1, handle_value2, handle_value3, handle_value4, handle_value5, handle_value6):
    ...
    if link==1:
        ...
        a = pickObject(client_id, handle_value1, handle_value2, handle_value3, handle_value4, handle_value5, handle_value6)
        print(a)
    elif link==16:
        a = placeObject(client_id,  handle_value1, handle_value2, handle_value3, handle_value4, handle_value5, handle_value6)
        print(a)
    else:
...
def pickObject(client_id,  handle_value1, handle_value2, handle_value3, handle_value4, handle_value5, handle_value6):
...
def placeObject(client_id,  handle_value1, handle_value2, handle_value3, handle_value4, handle_value5, handle_value6):
    ...
    sim.simxSetJointTargetPosition(client_id, handle_value6,0*3.14/180, sim.simx_opmode_oneshot)


    return 1

def resetPosition(client_id,  handle_value1, handle_value2, handle_value3, handle_value4, handle_value5, handle_value6):



    sim.simxSetJointTargetPosition(client_id, handle_value1,0*3.14/180, sim.simx_opmode_oneshot_wait)
    sim.simxSetJointTargetPosition(client_id, handle_value2,0*3.14/180, sim.simx_opmode_oneshot_wait)
    sim.simxSetJointTargetPosition(client_id, handle_value3,0*3.14/180, sim.simx_opmode_oneshot_wait)
    sim.simxSetJointTargetPosition(client_id, handle_value4,0*3.14/180, sim.simx_opmode_oneshot_wait)
    sim.simxSetJointTargetPosition(client_id, handle_value5,0*3.14/180, sim.simx_opmode_oneshot_wait)
    sim.simxSetJointTargetPosition(client_id, handle_value6,0*3.14/180, sim.simx_opmode_oneshot_wait)

...
if __name__ == "__main__":
    ...
    return_code, image_resolution, vision_sensor_image = sim.simxGetVisionSensorImage(client_id, visionSensorHandle, 0,sim.simx_opmode_streaming + 50)
    return_code, grip_image_resolution, vision_sensor_grip_image = sim.simxGetVisionSensorImage(client_id,visionSensorGripHandle, 0,sim.simx_opmode_streaming + 50)
    ...
    while True:
        ...
        return_code, grip_image_resolution, vision_sensor_grip_image = sim.simxGetVisionSensorImage(client_id,visionSensorGripHandle,0, sim.simx_opmode_buffer)
